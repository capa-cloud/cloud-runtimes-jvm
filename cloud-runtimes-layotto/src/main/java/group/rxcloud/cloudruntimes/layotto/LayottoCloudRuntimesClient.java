...
public class LayottoCloudRuntimesClient implements DefaultCloudRuntimesClient {

    public static final RuntimeClient LAYOTTO_CLIENT = LayottoClientProvider.LAYOTTO_CLIENT;

    @Override
    public List<String> registryNames() {
        return Collections.singletonList("layotto");
    }
    ...
    public Mono<Void> waitForSidecar(int timeoutInMilliseconds) {
        return Mono.fromCompletionStage(() ->
                CompletableFuture.runAsync(() ->
                        LAYOTTO_CLIENT.sayHello("check", timeoutInMilliseconds)));
    }
