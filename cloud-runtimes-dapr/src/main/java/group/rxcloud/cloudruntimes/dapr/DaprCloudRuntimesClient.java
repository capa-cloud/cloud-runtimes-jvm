...
public class DaprCloudRuntimesClient implements DefaultCloudRuntimesClient {

    public static final DaprClient DAPR_CLIENT = DaprClientProvider.DAPR_CLIENT;

    @Override
    public List<String> registryNames() {
        return Collections.singletonList("dapr");
    }

    @Override
    public Mono<Void> waitForSidecar(int timeoutInMilliseconds) {
        return DAPR_CLIENT.waitForSidecar(timeoutInMilliseconds);
    }
